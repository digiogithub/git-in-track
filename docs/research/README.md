...
| [Spec impact benchmark](./2026-09-25-spec-impact-benchmark.md) | this repository: 12 replayed PRs over the dogfood specs, re-run with Pando tiers 2–3 | `GIT-US-0137`, `GIT-US-0161`, `GIT-EP-0029` |
