...
internal/youtrack/       # YouTrack REST client (native-only, nothing imports it yet)
internal/syncengine/     # background job queue (native-only, nothing imports it yet)
