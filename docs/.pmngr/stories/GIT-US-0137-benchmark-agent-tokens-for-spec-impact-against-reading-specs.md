...
- [x] At least five real or replayed PRs touching the dogfooded capabilities are measured both ways with the same tokenizer approximation.
- [x] Results (tokens, hits, precision of tiers 1–2, candidates) are recorded in `docs/research/<date>-spec-impact-benchmark.md`.
- [x] The typical PR's report is ≤ 1.5k tokens and ≥ 10× cheaper; if not, follow-up stories are created in backlog.
- [x] Determinism check: running tiers 1–2 twice on each PR gives identical output.
